    ...
    for d in xrange(n_dir):
        for t in xrange(n_tim):
            ...
            for f in xrange(n_fre):
                ...
                for aa in xrange(n_ant):
                    for ab in xrange(n_ant):
                        jh[d,t,f,aa,ab,0,0] = g[d,rr,rc,aa,0,0]*m[d,t,f,aa,ab,0,0]

                        jh[d,t,f,aa,ab,0,1] = g[d,rr,rc,aa,0,0]*m[d,t,f,aa,ab,0,1]

                        jh[d,t,f,aa,ab,1,0] = g[d,rr,rc,aa,1,1]*m[d,t,f,aa,ab,1,0]

                        jh[d,t,f,aa,ab,1,1] = g[d,rr,rc,aa,1,1]*m[d,t,f,aa,ab,1,1]
            ...
            for f in xrange(n_fre):
                ...
                for aa in xrange(n_ant):
                    for ab in xrange(n_ant):
                        ...
                        jhr[d,rr,rc,aa,1,1] = jhr[d,rr,rc,aa,1,1] + gh[d,rr,rc,aa,0,0] * (
