...
class gocythonize(Command):
    ...
    def run(self):
        ...
        compiler_directives = {'binding': True, 'language_level': version_info.major}
        cythonize(extensions, compiler_directives=compiler_directives, annotate=True, force=self.force)
