            ...
            for t in range(n_tim):
                ...
                for f in range(n_fre):
                    ...
                    for d in range(n_dir):
                        ...
                        jhj[d,bt,bf,aa,0,0] += (jh00*j00)
                        jhj[d,bt,bf,aa,0,1] = 0
        ...
        for t in range(n_tim):
            for f in range(n_fre):
                for d in range(n_dir):
                    ...
                    upd[d,t,f,aa,0,0] = jhr00*jhjinv00
                    upd[d,t,f,aa,0,1] = 0
                    upd[d,t,f,aa,1,0] = 0
        ...
        for t in range(n_tim):
            ...
            for f in range(n_fre):
                ...
                for d in range(n_dir):
                    ...
                    g[d,t,f,aa,0,0] *= g_next[bd,bt,bf,aa,0,0]
                    g[d,t,f,aa,0,1] = 0
                    g[d,t,f,aa,1,0] = 0
                    g[d,t,f,aa,1,1] *= g_next[bd,bt,bf,aa,1,1]


# Map the J^H.J inversion method to a generic diagonal inversion.
