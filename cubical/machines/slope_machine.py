...
class PhaseSlopeGains(ParameterisedGains):
    ...
    def exportable_solutions():
        ...
        exportables.update({
            ...
            "delay1": (0., ("dir", "time", "freq", "ant", "corr")),
            "delay2": (0., ("dir", "time", "freq", "ant", "corr")),
        })
    ...
    def importable_solutions(self):
        ...
        return { "offset": self.interval_grid,
                 "delay1": self.interval_grid,
                 "delay2": self.interval_grid  }
    ...
    def export_solutions(self):
        ...
        if self.slope_type=="tf_plane":
            solutions.update({
                 "offset": (masked_array(self.slope_params[...,2,(0,1),(0,1)]), self.interval_grid),
                 "delay1": (masked_array(self.slope_params[...,0,(0,1),(0,1)]), self.interval_grid),
                 "delay2": (masked_array(self.slope_params[...,1,(0,1),(0,1)]), self.interval_grid),
            })
        elif self.slope_type=="f_slope":
            solutions.update({
             "offset": (masked_array(self.slope_params[...,1,(0,1),(0,1)]), self.interval_grid),
             "delay1": (masked_array(self.slope_params[...,0,(0,1),(0,1)]), self.interval_grid),
            })
        elif self.slope_type=="t_slope":
            solutions.update({
             "offset": (masked_array(self.slope_params[...,1,(0,1),(0,1)]), self.interval_grid),
             "delay2": (masked_array(self.slope_params[...,0,(0,1),(0,1)]), self.interval_grid),
            })
