...
import numpy as np
import cubical.kernels.cyf_slope as cyslope
...
class PhaseSlopeGains(ParameterisedGains):
    ...
    def compute_js(self, obser_arr, model_arr):
        ...
        cyslope.cycompute_jhr(tmp_jhr, jhr, self.chunk_fs, self.t_int, self.f_int)
    ...
    def compute_update(self, model_arr, obser_arr):
        ...
        cyslope.cyconstruct_gains(self.slope_params, self.gains, self.chunk_fs, self.t_int, self.f_int)
    ...
    def precompute_attributes(self, model_arr):
        ...
        cyslope.cycompute_jhj(tmp_jhj.real, jhj, self.chunk_fs, self.t_int, self.f_int)
