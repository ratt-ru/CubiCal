...
class PhaseSlopeGains(ParameterisedGains):
    ...
    def exportable_solutions(label):
        exportables = ParameterisedGains.exportable_solutions(label)
        exportables.update({
            "{}:phase".format(label): (0., ("dir", "time", "freq", "ant", "corr")),
            "{}:delay".format(label):  (0., ("dir", "time", "freq", "ant", "corr")),
        })
        return exportables
    ...
    def importable_solutions(self):
        ...
        return { "{}:phase".format(self.jones_label): self.interval_grid,
                 "{}:delay".format(self.jones_label): self.interval_grid }
    ...
    def export_solutions(self):
        ...
        solutions.update({
             "{}:phase".format(self.jones_label): (masked_array(self.slope_params[...,1,(0,1),(0,1)]), self.interval_grid),
             "{}:delay".format(self.jones_label): (masked_array(self.slope_params[...,0,(0,1),(0,1)]), self.interval_grid),
        })
        return solutions
    ...
    def import_solutions(self, soldict):
        ...
        phase = soldict.get("{}:phase".format(self.jones_label))
        delay = soldict.get("{}:delay".format(self.jones_label))
